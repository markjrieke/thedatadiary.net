...
- healthcare
tags: []
subtitle: 'Ordered categorical models for estimating Net Promoter Score: a hierarchical Bayesian implementation'
summary: ''
authors: []
lastmod: '2022-12-30T16:07:32-06:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
```{r simulate-units-read, echo=FALSE}
...
```{r simulate-ages-read, echo=FALSE}
...
```{r simulate-scores-read, echo=FALSE}
beta_age <- 0.35
