...
```{r, echo=FALSE}
blogdown::shortcode("tweet", "1454130028149620737")
blogdown::shortcode("tweet", "1455545666999042056")
```
...
```{r, echo=FALSE}
blogdown::shortcode("tweet", "1455544487149592576")
```
...
```{r, echo=FALSE}
blogdown::shortcode('tweet', "1455693099062153217")
blogdown::shortcode("tweet", "1455717564772986884")
```
