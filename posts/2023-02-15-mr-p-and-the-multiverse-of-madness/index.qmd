...
Between my job as a consumer experience analyst and my side-interest in electoral forecasting, I spend a *lot* of time digging into survey data. Surveys are great! But the survey sample may not always be representative of the population. When this is the case, we can't take the aggregated survey responses at face value and need to adjust for any bias the non-representativeness. 
