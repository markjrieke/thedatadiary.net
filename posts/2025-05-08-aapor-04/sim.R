...
wtmean <-
  cmdstan_model(
    "posts/2025-05-08-aapor-04/wtmean.stan",
    dir = "posts/2025-05-08-aapor-04/exe/"
  )

# poll aggregation model with a binomial likelihood
binomial_model <-
  cmdstan_model(
    "posts/2025-05-08-aapor-04/binomial.stan",
    dir = "posts/2025-05-08-aapor-04/exe/"
  )
...
beta_model <-
  cmdstan_model(
    "posts/2025-05-08-aapor-04/beta.stan",
    dir = "posts/2025-05-08-aapor-04/exe/"
  )
...
normal_model <-
  cmdstan_model(
    "posts/2025-05-08-aapor-04/normal.stan",
    dir = "posts/2025-05-08-aapor-04/exe/"
  )
...
ggquicksave("posts/2025-05-08-aapor-04/img/binomial_voteshare.png")

binomial_fit %>% plot_parameters()
ggquicksave("posts/2025-05-08-aapor-04/img/binomial_parameters.png")
...
ggquicksave("posts/2025-05-08-aapor-04/img/beta_voteshare.png")

beta_fit %>% plot_parameters()
ggquicksave("posts/2025-05-08-aapor-04/img/beta_parameters.png")
...
ggquicksave("posts/2025-05-08-aapor-04/img/normal_voteshare.png")

normal_fit %>% plot_parameters()
ggquicksave("posts/2025-05-08-aapor-04/img/normal_parameters.png")

# write out data for use in the article ----------------------------------------

groups %>%
  write_csv("posts/2025-05-08-aapor-04/data/groups.csv")
